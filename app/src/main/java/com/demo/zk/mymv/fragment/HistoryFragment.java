...
import com.demo.zk.mymv.database.History;
 ...
 * Use the {@link com.demo.zk.mymv.fragment.HistoryFragment#newInstance} factory method to
...
public class HistoryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFailReason = MyApplication.getResource().getString(R.string.fail_reason_no_history);
