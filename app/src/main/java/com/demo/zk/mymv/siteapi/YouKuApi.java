...
import com.demo.zk.mymv.model.SCChannelFilterItem;
import com.demo.zk.mymv.model.SCFailLog;
import com.demo.zk.mymv.model.SCSite;
import com.demo.zk.mymv.model.SCVideo;
import com.demo.zk.mymv.model.SCVideos;
import com.demo.zk.mymv.model.youku.searchresult.Result;
import com.demo.zk.mymv.model.youku.searchresult.SearchResults;
import com.demo.zk.mymv.model.youku.show.ShowInfo;
import com.demo.zk.mymv.model.youku.show.ShowVideos;
import com.demo.zk.mymv.model.youku.show.ShowVideosResult;
import com.demo.zk.mymv.utils.HttpUtils;
...
public class YouKuApi extends BaseSiteApi {
    ...
    private String getGUID()  {
        String str = null;
        str = md5(MyApplication.getMacAddress() + "&" + MyApplication.getIMEI() + "&" + "&");
        ...
        if(searchUrl == null) {
            ...
            HttpUtils.asyncGet(searchUrl,new Callback() {
                ...
                public void onResponse(Response response) {
                    ...
                    try {
                        SearchResults results =  MyApplication.getGson().fromJson(response.body().string(), SearchResults.class);
    ...
    public void doGetAlbumDesc(final SCAlbum album, final OnGetAlbumDescListener listener) {
        ...
        HttpUtils.asyncGet(url,new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    String ret = response.body().string();
                    ShowInfo showInfo = MyApplication.getGson().fromJson(ret,ShowInfo.class);
                    if(showInfo.getStatus().equals(SUCCESS))
    ...
    public void doGetAlbumVideos(final SCAlbum album, int pageNo, int pageSize, final OnGetVideosListener listener) {
        ...
        HttpUtils.asyncGet(url,new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                String ret = response.body().string();
                ShowVideos  videos = MyApplication.getGson().fromJson(ret,ShowVideos.class);
