package com.demo.zk.mymv.utils;
...
public class HttpUtils {
    ...
    public static String syncGet(String url) {
        ...
        try {
            Response response =  MyApplication.getHttpClient().newCall(request).execute();
    ...
    public static void asyncGet(Request request, final Activity activity, final Callback callback) {
        ...
        MyApplication.getHttpClient().newCall(request).enqueue(new Callback() {
    ...
    public static void cancelAll() {
        MyApplication.getHttpClient().cancel(REQUEST_TAG);
    }
