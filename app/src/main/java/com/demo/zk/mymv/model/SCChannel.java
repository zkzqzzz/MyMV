...
public class SCChannel {
    ...
    public SCChannel(int mChannelID) {
        ...
        if(mChannelID == SHOW)
            mChannelName = MyApplication.getResource().getString(R.string.channel_show);
        else if(mChannelID == MOVIE)
            mChannelName = MyApplication.getResource().getString(R.string.channel_movie);
        else if(mChannelID == COMIC)
            mChannelName = MyApplication.getResource().getString(R.string.channel_comic);
        //else if(mChannelID == ENT)
        //    mChannelName = SailorCast.getResource().getString(R.string.channel_ent);
        else if(mChannelID == DOCUMENTARY)
            mChannelName = MyApplication.getResource().getString(R.string.channel_documentary);
        else if(mChannelID == MUSIC)
            mChannelName = MyApplication.getResource().getString(R.string.channel_music);
        else if(mChannelID == VARIETY)
            mChannelName = MyApplication.getResource().getString(R.string.channel_variety);
        else if(mChannelID == LOCAL_BOOKMARK)
            mChannelName = MyApplication.getResource().getString(R.string.channel_bookmark);
        else if(mChannelID == LOCAL_HISTORY)
            mChannelName = MyApplication.getResource().getString(R.string.channel_history);
        else
