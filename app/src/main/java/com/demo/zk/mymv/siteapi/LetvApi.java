...
import com.demo.zk.mymv.model.SCLiveStreamProgram;
import com.demo.zk.mymv.model.SCLiveStreamPrograms;
import com.demo.zk.mymv.model.SCLiveStreamType;
...
import com.demo.zk.mymv.model.SCWeekDay;
import com.demo.zk.mymv.utils.HttpUtils;
import com.demo.zk.mymv.utils.MD5;
                        ...
                        if(jsonArray != null && jsonArray.length() > 0) {
                            ...
                            if(videos.size() > 0) {
                                ...
                                if(listener!=null) {
                                    ...
                                    err.setReason(MyApplication.getResource().getString(R.string.err_wrong_data));
                                    listener.onGetVideosFailed(err);
                                }
                            }
                        }
            ...
            public void onResponse(Response response) throws IOException {
                ...
                if(albums != null) {
                    ...
                    if(listener != null) {
                        ...
                        err.setReason(MyApplication.getResource().getString(R.string.fail_reason_no_results));
                        listener.onGetAlbumsFailed(err);
                    }
                }
