...
import com.demo.zk.mymv.database.HistoryDbHelper;
import com.demo.zk.mymv.fragment.AlbumPlayGridFragment;
...
import com.demo.zk.mymv.siteapi.OnGetAlbumDescListener;
import com.demo.zk.mymv.siteapi.OnGetVideoPlayUrlListener;
import com.demo.zk.mymv.siteapi.SiteApi;
...
import static com.demo.zk.mymv.R.id.error_message;
    ...
    , OnGetVideoPlayUrlListener
{
    ...
    protected void onResume() {
        super.onResume();
        MyApplication.upnpServiceController.resume(this);
    }
	...
	{
		super.onPause();
        MyApplication.upnpServiceController.pause();
        MyApplication.upnpServiceController.getServiceListener().getServiceConnexion().onServiceDisconnected(null);
	}
    ...
    public void onPlayButtonClick(View button) {
        ...
        boolean isWifi = MyApplication.isNetworkWifi();
	...
	private void launchRenderer(SCVideo video, String url)
	{
		...
		IRendererCommand rendererCommand = MyApplication.factory.createRendererCommand(MyApplication.factory.createRendererState());
