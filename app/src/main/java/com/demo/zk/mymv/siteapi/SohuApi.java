...
import com.demo.zk.mymv.model.sohu.album.Album;
import com.demo.zk.mymv.model.sohu.searchresult.SearchResultAlbum;
import com.demo.zk.mymv.model.sohu.searchresult.SearchResults;
import com.demo.zk.mymv.model.sohu.videos.Video;
import com.demo.zk.mymv.model.sohu.videos.Videos;
    ...
    public void doSearch(String key, final OnGetAlbumsListener listener) {
        ...
        HttpUtils.asyncGet(url, new Callback() {
            ...
            public void onResponse(Response response) {
                ...
                try {
                    results = MyApplication.getGson().fromJson(response.body().string(), SearchResults.class);
    ...
    public void doGetAlbumVideos(final SCAlbum album, final int pageNo, final int pageSize, final OnGetVideosListener listener) {
        ...
        HttpUtils.asyncGet(url,new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    Videos videos = MyApplication.getGson().fromJson(response.body().string(), Videos.class);
    ...
    public void doGetAlbumDesc(final SCAlbum album, final OnGetAlbumDescListener listener) {
        ...
        HttpUtils.asyncGet(url, new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                Album a = MyApplication.getGson().fromJson(response.body().string(), Album.class);
