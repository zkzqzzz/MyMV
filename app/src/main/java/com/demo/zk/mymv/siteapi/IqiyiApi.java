...
public class IqiyiApi extends BaseSiteApi {
    ...
    public void doGetChannelFilter(final SCChannel channel, final OnGetChannelFilterListener listener) {
        ...
        InputStream ins = MyApplication.getContext().getResources().openRawResource(
                MyApplication.getContext().getResources().getIdentifier("iqiyi",
                        "raw", MyApplication.getContext().getPackageName()));
