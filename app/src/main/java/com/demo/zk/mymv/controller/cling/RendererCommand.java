...
import com.demo.zk.mymv.model.cling.CDevice;
import com.demo.zk.mymv.model.cling.RendererState;
import com.demo.zk.mymv.model.cling.TrackMetadata;
import com.demo.zk.mymv.model.cling.didl.ClingDIDLItem;
import com.demo.zk.mymv.model.upnp.IRendererCommand;
import com.demo.zk.mymv.model.upnp.didl.IDIDLItem;
...
public class RendererCommand implements Runnable, IRendererCommand {
	...
	{
		if (MyApplication.upnpServiceController.getSelectedRenderer() == null)
			return null;

		return ((CDevice) MyApplication.upnpServiceController.getSelectedRenderer()).getDevice().findService(
